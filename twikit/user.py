...
class User:
    ...
    def __init__(self, client: Client, data: dict) -> None:
        self._client = client
        # X retired the flat `legacy` payload; fields now live in nested
        ...
        desc_urls = bio_entities.get('description') or legacy_entities.get('description', {})
        self.description_urls: list = (desc_urls or {}).get('urls', [])
        self.urls: list = (legacy_entities.get('url', {}) or {}).get('urls')
