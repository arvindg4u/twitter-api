...
class Endpoint:
    ...
    SEARCH_TIMELINE = url('KPSo2_UWdOMpPJwjhfT1Qg/SearchTimeline')
    SIMILAR_POSTS = url('v0VfcmfXXkgMZP_82_vqgQ/SimilarPosts')
    CREATE_NOTE_TWEET = url('XlRlDgkQECaYZaZ0XFhMLg/CreateNoteTweet')
    CREATE_TWEET = url('CUWCG7oBfrG71ZUXUtpwbw/CreateTweet')
    ...
    USER_BY_SCREEN_NAME = url('KybxDj9RrADIITXlGG8kpw/UserByScreenName')
    USER_BY_REST_ID = url('IdmRdjYxIGI39Hdwkwo5cQ/UserByRestId')
    TWEET_DETAIL = url('FyR-GrebyjdkRoW1z6uCgQ/TweetDetail')
    TWEET_RESULT_BY_REST_ID = url('snmujSvB_9WXyd8yjvZ24Q/TweetResultByRestId')
    ...
    USER_TWEETS = url('OeFjWKHutsuyWXZGmLr02A/UserTweets')
    USER_TWEETS_AND_REPLIES = url('-4Ujf5pYzDdr_qY8qxgF9A/UserTweetsAndReplies')
    USER_MEDIA = url('atLYUUmER14HCLFnNUKJgA/UserMedia')
    USER_LIKES = url('o000A_Cp4JPOihhbeEgi0g/Likes')
    USER_HIGHLIGHTS_TWEETS = url('joXNEXA_o1gX_7xL-iHFOg/UserHighlightsTweets')
    ...
    FOLLOWERS = url('sF7aRC2fRq7OGOOp_qHntA/Followers')
    BLUE_VERIFIED_FOLLOWERS = url('UmyQcnz4ojpneJPQeMlPeg/BlueVerifiedFollowers')
    FOLLOWERS_YOU_KNOW = url('OadxGUsFAzdbXwLtjvnXCg/FollowersYouKnow')
    FOLLOWING = url('4EQGMEhtdVw8NeVBDQHESQ/Following')
    USER_CREATOR_SUBSCRIPTIONS = url('f-Cbl2jd7rOHB6zlu8GmZw/UserCreatorSubscriptions')
    ...
    TWEET_RESULTS_BY_REST_IDS = url('VwY22EyG-lO-eT6Myg_F0A/TweetResultsByRestIds')
